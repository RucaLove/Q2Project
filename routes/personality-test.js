...
router.get('/', (req, res, next) => {
  ...
  if (!req.cookies.newUser) {
    ...
    console.log('Welcome existing user\n', req.cookies.regUser.name);
      ...
      res.render('test', {name: req.cookies.regUser.name, message: 'Welcome back: ', testStatus: testStatus, userid: userid})
    })
      ...
      res.render('test', {name: req.cookies.regUser.name, message: 'Welcome: '});
  }
})
